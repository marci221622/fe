...
function createBaseFavoriteList(): FavoriteList {
  return { id: "", owner: undefined, title: undefined, description: undefined, image: undefined, items: [] };
}

export const FavoriteList = {
  encode(message: FavoriteList, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): FavoriteList {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseFavoriteList();
  ...
  fromJSON(object: any): FavoriteList {
    return {
  ...
  toJSON(message: FavoriteList): unknown {
    const obj: any = {};
    if (message.id !== "") {
      obj.id = message.id;
    }
  ...
  create<I extends Exact<DeepPartial<FavoriteList>, I>>(base?: I): FavoriteList {
    return FavoriteList.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<FavoriteList>, I>>(object: I): FavoriteList {
    const message = createBaseFavoriteList();
