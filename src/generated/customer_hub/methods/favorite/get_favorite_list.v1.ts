...
function createBaseGetFavoriteListRequest(): GetFavoriteListRequest {
...
export const GetFavoriteListRequest = {
  encode(message: GetFavoriteListRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetFavoriteListRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetFavoriteListRequest();
  ...
  fromJSON(object: any): GetFavoriteListRequest {
    return {
  ...
  toJSON(message: GetFavoriteListRequest): unknown {
    const obj: any = {};
    if (message.sessionData !== undefined) {
  ...
  create<I extends Exact<DeepPartial<GetFavoriteListRequest>, I>>(base?: I): GetFavoriteListRequest {
    return GetFavoriteListRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetFavoriteListRequest>, I>>(object: I): GetFavoriteListRequest {
    const message = createBaseGetFavoriteListRequest();
...
function createBaseGetFavoriteListResponse(): GetFavoriteListResponse {
  return { items: [], itemsCount: "0", nextPageToken: "" };
}

export const GetFavoriteListResponse = {
  encode(message: GetFavoriteListResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetFavoriteListResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetFavoriteListResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): GetFavoriteListResponse {
    return {
  ...
  toJSON(message: GetFavoriteListResponse): unknown {
    const obj: any = {};
  ...
  create<I extends Exact<DeepPartial<GetFavoriteListResponse>, I>>(base?: I): GetFavoriteListResponse {
    return GetFavoriteListResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetFavoriteListResponse>, I>>(object: I): GetFavoriteListResponse {
    const message = createBaseGetFavoriteListResponse();
