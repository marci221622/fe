...
export interface GetAuthenticationCodeIosRequest {
  /** Данные пользователя */
  contact:
    | ContactData
    | undefined;
...
export interface GetAuthenticationCodeIosResponse {
  /** Код авторизации */
  code: string;
...
function createBaseGetAuthenticationCodeIosRequest(): GetAuthenticationCodeIosRequest {
  return { contact: undefined, verificationInfo: undefined, sessionData: undefined };
}

export const GetAuthenticationCodeIosRequest = {
  encode(message: GetAuthenticationCodeIosRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetAuthenticationCodeIosRequest {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetAuthenticationCodeIosRequest();
  ...
  fromJSON(object: any): GetAuthenticationCodeIosRequest {
    return {
  ...
  toJSON(message: GetAuthenticationCodeIosRequest): unknown {
    const obj: any = {};
    if (message.contact !== undefined) {
  ...
  create<I extends Exact<DeepPartial<GetAuthenticationCodeIosRequest>, I>>(base?: I): GetAuthenticationCodeIosRequest {
    return GetAuthenticationCodeIosRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetAuthenticationCodeIosRequest>, I>>(
    object: I,
...
function createBaseGetAuthenticationCodeIosResponse(): GetAuthenticationCodeIosResponse {
  return { code: "", meta: undefined };
}

export const GetAuthenticationCodeIosResponse = {
  encode(message: GetAuthenticationCodeIosResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.code !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): GetAuthenticationCodeIosResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetAuthenticationCodeIosResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): GetAuthenticationCodeIosResponse {
    return {
  ...
  toJSON(message: GetAuthenticationCodeIosResponse): unknown {
    const obj: any = {};
    if (message.code !== "") {
  ...
  create<I extends Exact<DeepPartial<GetAuthenticationCodeIosResponse>, I>>(
    base?: I,
  ): GetAuthenticationCodeIosResponse {
    return GetAuthenticationCodeIosResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetAuthenticationCodeIosResponse>, I>>(
    object: I,
  ): GetAuthenticationCodeIosResponse {
    const message = createBaseGetAuthenticationCodeIosResponse();
